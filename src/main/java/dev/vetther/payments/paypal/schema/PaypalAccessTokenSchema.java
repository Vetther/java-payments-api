...
public class PaypalAccessTokenSchema {
    ...
    private PaypalAccessTokenSchema(String scope, String access_token, String token_type, String app_id, int expires_in, String nonce) {
        this.scope = scope;
