...
public class HotpayApiCreatePsc {

    @Getter private final String url;

    HotpayApiCreatePsc(String secret, double amount, String itemName, String redirectUrl, String paymentId) {
        ...
        this.url = "https://psc.hotpay.pl?" + FormUtils.createForm(formMap);
    }
}
